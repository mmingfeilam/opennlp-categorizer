	...
	public static void main(String[] args) throws InvalidFormatException, IOException {
		...
		String[] sentences = {
				...
				"Mr. Draghi spoke on the first day of an economic policy conference here organized by"
						...
						+ " Hole, Wyo., by the Federal Reserve Bank of Kansas City. Sixteen dollars is not a lot of money.  "
						+ "Sixty dollars is a lot of money.  It's now 5 o'clock.  Tomorrow 10 PM EST." };

		// Load the model file downloaded from OpenNLP
		// http://opennlp.sourceforge.net/models-1.5/en-ner-person.bin
		TokenNameFinderModel model = new TokenNameFinderModel(new File("input/en-ner-person.bin"));
